...
test.skip("deposit_statement_pdf writes an A4 PDF titled DEPOSIT STATEMENT on Pro", async (t) => {
...
test.skip("deposits_report names what is held, the oldest, and the unapplied older than N days", async (t) => {
  const { box, c } = open(t, { key: proKey() });
  seedInvoice(box.dataHome, simpleInvoice("INV-2026-0001"));
  await c.init();
